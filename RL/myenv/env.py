...
class RamenPlanning(gym.Env):
	...
	def _step_for_optimization(self, action):
		...
		# this method does NOT change current state

		before = copy.deepcopy([self.sec_num,self.section])
		...
		after = copy.deepcopy([self.sec_num,self.section])
		self.sec_num = before[0]
		self.section = before[1]
